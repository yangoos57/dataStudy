...
- Event buses can be accessed by other AWS accounts using Resource-based Policie
...
- Advantages
    ...
    - Enable CloudTrail on all accounts, send logs to central S3 account - Send CloudWatch Logs to central logging account
...
- **Option1 : Accessfromthepublic internet**
- BecauseLambdaisinaVPC,it needs a NAT Gateway in a public subnet and an internet gateway
